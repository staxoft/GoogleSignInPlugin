...
namespace E_Token.GoogleSignInPlugin
{
    ...
    {
        public const string SignInDefaultErrorMessage =
            "The Google Sign In could not complete it's process correctly. Make sure you have added google-services.json file to your project and the SHA certificate fingerprint to your Firebase Android App in the Firebase Console Portal";

        public const string SignInUnknownErrorMessage = "An unknown error has occured.";

        public const string SignInKeychainErrorMessage =
            "There was a problem reading or writing to the application keychain.";

        public const string SignInNoSignInHandlersInstalledErrorMessage =
            "No appropriate applications are installed on the user's device which can handle sign-in.";
        ...
        public const string SignInInvalidAccountErrorMessage =
            "Attempted to connect to the service with an invalid account name specified.";

        public const string SignInNetworkErrorMessage =
            "A network error occurred. Retrying should resolve the problem.";

        public const string SignInInternalErrorMessage =
            "An internal error occurred. Retrying should resolve the problem.";

        public const string SignInRequiredErrorMessage =
    ...
    public class GoogleClientSignInNoSignInHandlersInstalledErrorException : GoogleClientBaseException
    {
        public GoogleClientSignInNoSignInHandlersInstalledErrorException() : base(
            SignInNoSignInHandlersInstalledErrorMessage)
        {
        }
        ...
        public GoogleClientSignInNoSignInHandlersInstalledErrorException(string message, Exception inner) : base(
            message, inner)
        {
        }
    }
    ...
    public class GoogleClientSignInHasNoAuthInKeychainErrorException : GoogleClientBaseException
    {
        ...
        public GoogleClientSignInHasNoAuthInKeychainErrorException(string message, Exception inner) : base(message,
            inner)
        {
        }
    }
